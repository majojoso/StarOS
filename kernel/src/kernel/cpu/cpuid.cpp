...
#define CPUID_VENDOR_AMD_OLD       "AMDisbetter!" //Early AMD K5 samples
...
#define CPUID_VENDOR_PARALLELS_ALT " lrpepyh vr " //Endianness Mismatch
...
void CpuidGetVendor(char *Vendor)
{
	...
	*((UInt32 *) (UInt8 *) (&Vendor[0])) = EBX;
	*((UInt32 *) (UInt8 *) (&Vendor[4])) = EDX;
	*((UInt32 *) (UInt8 *) (&Vendor[8])) = ECX;
}
...
bool CpuidCheckApic()
{
	return CpuidCheckFlagEdx(CPUID_FEAT_EDX_APIC);
}
